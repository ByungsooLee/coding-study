...
export function ProblemFilters({ value, onChange, topics }: Props) {
  const set = <K extends keyof ProblemFilterState>(k: K, v: ProblemFilterState[K]) =>
    onChange({ ...value, [k]: v });
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      />
      <Select value={value.topic} onChange={(e) => set("topic", e.target.value as LeetcodeTopic | "All")}>
